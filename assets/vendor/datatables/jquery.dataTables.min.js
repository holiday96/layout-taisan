...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Lên đầu",sLast:"Tới cuối",sNext:"Tiếp theo",sPrevious:"Quay lại"},sEmptyTable:"Không có dữ liệu trên bảng",sInfo:"Hiển thị từ _START_ đến _END_ của _TOTAL_ bản ghi",sInfoEmpty:"Hiển thị từ 0 đến 0 của 0 bản ghi",
