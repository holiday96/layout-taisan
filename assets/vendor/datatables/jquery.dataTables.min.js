...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Lên đầu",sLast:"Tới cuối",sNext:"Tiếp theo",sPrevious:"Quay lại"},sEmptyTable:"Không có dữ liệu trên bảng",sInfo:"Hiển thị bản ghi _START_ đến _END_ trang _TOTAL_",sInfoEmpty:"Hiển thị bản ghi 0 đến 0 trang 0",
sInfoFiltered:"(được lọc từ tổng số _MAX_ bản ghi)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Hiển thị _MENU_ bản ghi",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Tìm kiếm:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Không có kết quả"},oSearch:h.extend({},l.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
